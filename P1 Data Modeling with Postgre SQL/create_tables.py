...
def create_database():
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname= udacity1 user=postgres password=postgre")
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=postgres password=postgre")
    cur = conn.cursor()
